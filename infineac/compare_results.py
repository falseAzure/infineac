...
# def aggregate_results(df: pl.DataFrame):
#     df_dict = df.select(
#         "category_intersection",
#         "category_union",
#         "exit_strategy",
...
#     strategy_list = []
#     for i in range(len(df_dict["category_intersection"])):
#         lst_ = []
#         if df_dict["exit_strategy"][i] > 0:
#             lst_.append("exit")
#         if df_dict["adaptation_strategy"][i] > 0:
#             lst_.append("adaptation")
#         if df_dict["stay_strategy"][i] > 0:
#             lst_.append("stay")
...
#     count = count.with_columns(intersection=0)
#     count = count.with_columns(union=0)

#     for i, categories in enumerate(df_dict["category_intersection"]):
#         strategies = strategy_list[i]
#         if len(categories) == 0:
#             continue
#         if len(strategies) == 0:
#             count = count.with_columns(
#                 intersection=pl.when(
#                     pl.col("category").is_in(categories)
#                     & (pl.col("strategy") == "no strategy")
#                 )
#                 .then(pl.col("intersection") + 1)
#                 .otherwise(pl.col("intersection"))
#             )
#             continue
#         count = count.with_columns(
#             intersection=pl.when(
...
#     for i, categories in enumerate(df_dict["category_union"]):
#         strategies = strategy_list[i]
#         if len(categories) == 0:
#             continue
#         if len(strategies) == 0:
